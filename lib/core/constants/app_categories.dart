...
class CategoryTaxonomy {
  ...
  static const Map<String, List<String>> incomeTree = <String, List<String>>{
    ...
    '기타': <String>['미분류', '송금', nonIncomeSubcategory, '기타'],
  };

  /// **들어왔지만 내 소득이 아닌 돈.**
  ///
  /// 계좌 인증용 1원, 오입금, 곧 돌려줄 돈 같은 것들이다. 통장에는 찍혔지만
  /// "이번 달 얼마 벌었나" 의 답이 아니다.
  ///
  /// [settlementCategory] 와는 다르다. 정산은 **내가 쓴 돈을 돌려받은 것**
  /// 이라 성격이 분명하고, 나중에 "정산으로 얼마 받았나" 를 따로 보게 된다.
  /// 둘을 섞으면 그 질문에 답할 수 없다.
  static const String nonIncomeSubcategory = '인증/오입금';
